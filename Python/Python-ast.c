...
_Py_IDENTIFIER(visit_mod);
#define INDEX_mod 0
_Py_IDENTIFIER(visit_Module);
#define INDEX_Module 1
_Py_IDENTIFIER(visit_Interactive);
#define INDEX_Interactive 2
_Py_IDENTIFIER(visit_Expression);
#define INDEX_Expression 3
_Py_IDENTIFIER(visit_FunctionType);
#define INDEX_FunctionType 4
_Py_IDENTIFIER(visit_Suite);
#define INDEX_Suite 5
_Py_IDENTIFIER(visit_stmt);
#define INDEX_stmt 6
_Py_IDENTIFIER(visit_FunctionDef);
#define INDEX_FunctionDef 7
_Py_IDENTIFIER(visit_AsyncFunctionDef);
#define INDEX_AsyncFunctionDef 8
_Py_IDENTIFIER(visit_ClassDef);
#define INDEX_ClassDef 9
_Py_IDENTIFIER(visit_Return);
#define INDEX_Return 10
_Py_IDENTIFIER(visit_Delete);
#define INDEX_Delete 11
_Py_IDENTIFIER(visit_Assign);
#define INDEX_Assign 12
_Py_IDENTIFIER(visit_AugAssign);
#define INDEX_AugAssign 13
_Py_IDENTIFIER(visit_AnnAssign);
#define INDEX_AnnAssign 14
_Py_IDENTIFIER(visit_For);
#define INDEX_For 15
_Py_IDENTIFIER(visit_AsyncFor);
#define INDEX_AsyncFor 16
_Py_IDENTIFIER(visit_While);
#define INDEX_While 17
_Py_IDENTIFIER(visit_If);
#define INDEX_If 18
_Py_IDENTIFIER(visit_With);
#define INDEX_With 19
_Py_IDENTIFIER(visit_AsyncWith);
#define INDEX_AsyncWith 20
_Py_IDENTIFIER(visit_Raise);
#define INDEX_Raise 21
_Py_IDENTIFIER(visit_Try);
#define INDEX_Try 22
_Py_IDENTIFIER(visit_Assert);
#define INDEX_Assert 23
_Py_IDENTIFIER(visit_Import);
#define INDEX_Import 24
_Py_IDENTIFIER(visit_ImportFrom);
#define INDEX_ImportFrom 25
_Py_IDENTIFIER(visit_Global);
#define INDEX_Global 26
_Py_IDENTIFIER(visit_Nonlocal);
#define INDEX_Nonlocal 27
_Py_IDENTIFIER(visit_Expr);
#define INDEX_Expr 28
_Py_IDENTIFIER(visit_Pass);
#define INDEX_Pass 29
_Py_IDENTIFIER(visit_Break);
#define INDEX_Break 30
_Py_IDENTIFIER(visit_Continue);
#define INDEX_Continue 31
_Py_IDENTIFIER(visit_expr);
#define INDEX_expr 32
_Py_IDENTIFIER(visit_BoolOp);
#define INDEX_BoolOp 33
_Py_IDENTIFIER(visit_NamedExpr);
#define INDEX_NamedExpr 34
_Py_IDENTIFIER(visit_BinOp);
#define INDEX_BinOp 35
_Py_IDENTIFIER(visit_UnaryOp);
#define INDEX_UnaryOp 36
_Py_IDENTIFIER(visit_Lambda);
#define INDEX_Lambda 37
_Py_IDENTIFIER(visit_IfExp);
#define INDEX_IfExp 38
_Py_IDENTIFIER(visit_Dict);
#define INDEX_Dict 39
_Py_IDENTIFIER(visit_Set);
#define INDEX_Set 40
_Py_IDENTIFIER(visit_ListComp);
#define INDEX_ListComp 41
_Py_IDENTIFIER(visit_SetComp);
#define INDEX_SetComp 42
_Py_IDENTIFIER(visit_DictComp);
#define INDEX_DictComp 43
_Py_IDENTIFIER(visit_GeneratorExp);
#define INDEX_GeneratorExp 44
_Py_IDENTIFIER(visit_Await);
#define INDEX_Await 45
_Py_IDENTIFIER(visit_Yield);
#define INDEX_Yield 46
_Py_IDENTIFIER(visit_YieldFrom);
#define INDEX_YieldFrom 47
_Py_IDENTIFIER(visit_Compare);
#define INDEX_Compare 48
_Py_IDENTIFIER(visit_Call);
#define INDEX_Call 49
_Py_IDENTIFIER(visit_FormattedValue);
#define INDEX_FormattedValue 50
_Py_IDENTIFIER(visit_JoinedStr);
#define INDEX_JoinedStr 51
_Py_IDENTIFIER(visit_Constant);
#define INDEX_Constant 52
_Py_IDENTIFIER(visit_Attribute);
#define INDEX_Attribute 53
_Py_IDENTIFIER(visit_Subscript);
#define INDEX_Subscript 54
_Py_IDENTIFIER(visit_Starred);
#define INDEX_Starred 55
_Py_IDENTIFIER(visit_Name);
#define INDEX_Name 56
_Py_IDENTIFIER(visit_List);
#define INDEX_List 57
_Py_IDENTIFIER(visit_Tuple);
#define INDEX_Tuple 58
_Py_IDENTIFIER(visit_expr_context);
#define INDEX_expr_context 59
_Py_IDENTIFIER(visit_Load);
#define INDEX_Load 60
_Py_IDENTIFIER(visit_Store);
#define INDEX_Store 61
_Py_IDENTIFIER(visit_Del);
#define INDEX_Del 62
_Py_IDENTIFIER(visit_AugLoad);
#define INDEX_AugLoad 63
_Py_IDENTIFIER(visit_AugStore);
#define INDEX_AugStore 64
_Py_IDENTIFIER(visit_Param);
#define INDEX_Param 65
_Py_IDENTIFIER(visit_slice);
#define INDEX_slice 66
_Py_IDENTIFIER(visit_Slice);
#define INDEX_Slice 67
_Py_IDENTIFIER(visit_ExtSlice);
#define INDEX_ExtSlice 68
_Py_IDENTIFIER(visit_Index);
#define INDEX_Index 69
_Py_IDENTIFIER(visit_boolop);
#define INDEX_boolop 70
_Py_IDENTIFIER(visit_And);
#define INDEX_And 71
_Py_IDENTIFIER(visit_Or);
#define INDEX_Or 72
_Py_IDENTIFIER(visit_operator);
#define INDEX_operator 73
_Py_IDENTIFIER(visit_Add);
#define INDEX_Add 74
_Py_IDENTIFIER(visit_Sub);
#define INDEX_Sub 75
_Py_IDENTIFIER(visit_Mult);
#define INDEX_Mult 76
_Py_IDENTIFIER(visit_MatMult);
#define INDEX_MatMult 77
_Py_IDENTIFIER(visit_Div);
#define INDEX_Div 78
_Py_IDENTIFIER(visit_Mod);
#define INDEX_Mod 79
_Py_IDENTIFIER(visit_Pow);
#define INDEX_Pow 80
_Py_IDENTIFIER(visit_LShift);
#define INDEX_LShift 81
_Py_IDENTIFIER(visit_RShift);
#define INDEX_RShift 82
_Py_IDENTIFIER(visit_BitOr);
#define INDEX_BitOr 83
_Py_IDENTIFIER(visit_BitXor);
#define INDEX_BitXor 84
_Py_IDENTIFIER(visit_BitAnd);
#define INDEX_BitAnd 85
_Py_IDENTIFIER(visit_FloorDiv);
#define INDEX_FloorDiv 86
_Py_IDENTIFIER(visit_unaryop);
#define INDEX_unaryop 87
_Py_IDENTIFIER(visit_Invert);
#define INDEX_Invert 88
_Py_IDENTIFIER(visit_Not);
#define INDEX_Not 89
_Py_IDENTIFIER(visit_UAdd);
#define INDEX_UAdd 90
_Py_IDENTIFIER(visit_USub);
#define INDEX_USub 91
_Py_IDENTIFIER(visit_cmpop);
#define INDEX_cmpop 92
_Py_IDENTIFIER(visit_Eq);
#define INDEX_Eq 93
_Py_IDENTIFIER(visit_NotEq);
#define INDEX_NotEq 94
_Py_IDENTIFIER(visit_Lt);
#define INDEX_Lt 95
_Py_IDENTIFIER(visit_LtE);
#define INDEX_LtE 96
_Py_IDENTIFIER(visit_Gt);
#define INDEX_Gt 97
_Py_IDENTIFIER(visit_GtE);
#define INDEX_GtE 98
_Py_IDENTIFIER(visit_Is);
#define INDEX_Is 99
_Py_IDENTIFIER(visit_IsNot);
#define INDEX_IsNot 100
_Py_IDENTIFIER(visit_In);
#define INDEX_In 101
_Py_IDENTIFIER(visit_NotIn);
#define INDEX_NotIn 102
_Py_IDENTIFIER(visit_comprehension);
#define INDEX_comprehension 103
_Py_IDENTIFIER(visit_excepthandler);
#define INDEX_excepthandler 104
_Py_IDENTIFIER(visit_ExceptHandler);
#define INDEX_ExceptHandler 105
_Py_IDENTIFIER(visit_arguments);
#define INDEX_arguments 106
_Py_IDENTIFIER(visit_arg);
#define INDEX_arg 107
_Py_IDENTIFIER(visit_keyword);
#define INDEX_keyword 108
_Py_IDENTIFIER(visit_alias);
#define INDEX_alias 109
_Py_IDENTIFIER(visit_withitem);
#define INDEX_withitem 110
_Py_IDENTIFIER(visit_type_ignore);
#define INDEX_type_ignore 111
_Py_IDENTIFIER(visit_TypeIgnore);
#define INDEX_TypeIgnore 112
_Py_IDENTIFIER(visit);
#define INDEX_visit 113
_Py_IDENTIFIER(generic_visit);
#define INDEX_generic_visit 114
#define NUM_METHODS 115
...
initialize_nodevisitor_table(PyTypeObject *type, NodeVisitorDispatchTable *existing_table)
{
    ...
    if (initialize_entry((PyObject*)type, &PyId_visit_mod,
        &table->entries[INDEX_mod], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Module,
        &table->entries[INDEX_Module], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Interactive,
        &table->entries[INDEX_Interactive],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Expression,
        &table->entries[INDEX_Expression], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_FunctionType,
        &table->entries[INDEX_FunctionType],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Suite,
        &table->entries[INDEX_Suite], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_stmt,
        &table->entries[INDEX_stmt], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_FunctionDef,
        &table->entries[INDEX_FunctionDef],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_AsyncFunctionDef,
        &table->entries[INDEX_AsyncFunctionDef],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_ClassDef,
        &table->entries[INDEX_ClassDef], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Return,
        &table->entries[INDEX_Return], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Delete,
        &table->entries[INDEX_Delete], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Assign,
        &table->entries[INDEX_Assign], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_AugAssign,
        &table->entries[INDEX_AugAssign], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_AnnAssign,
        &table->entries[INDEX_AnnAssign], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_For,
        &table->entries[INDEX_For], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_AsyncFor,
        &table->entries[INDEX_AsyncFor], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_While,
        &table->entries[INDEX_While], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_If,
        &table->entries[INDEX_If], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_With,
        &table->entries[INDEX_With], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_AsyncWith,
        &table->entries[INDEX_AsyncWith], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Raise,
        &table->entries[INDEX_Raise], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Try,
        &table->entries[INDEX_Try], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Assert,
        &table->entries[INDEX_Assert], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Import,
        &table->entries[INDEX_Import], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_ImportFrom,
        &table->entries[INDEX_ImportFrom], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Global,
        &table->entries[INDEX_Global], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Nonlocal,
        &table->entries[INDEX_Nonlocal], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Expr,
        &table->entries[INDEX_Expr], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Pass,
        &table->entries[INDEX_Pass], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Break,
        &table->entries[INDEX_Break], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Continue,
        &table->entries[INDEX_Continue], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_expr,
        &table->entries[INDEX_expr], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_BoolOp,
        &table->entries[INDEX_BoolOp], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_NamedExpr,
        &table->entries[INDEX_NamedExpr], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_BinOp,
        &table->entries[INDEX_BinOp], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_UnaryOp,
        &table->entries[INDEX_UnaryOp], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Lambda,
        &table->entries[INDEX_Lambda], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_IfExp,
        &table->entries[INDEX_IfExp], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Dict,
        &table->entries[INDEX_Dict], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Set,
        &table->entries[INDEX_Set], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_ListComp,
        &table->entries[INDEX_ListComp], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_SetComp,
        &table->entries[INDEX_SetComp], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_DictComp,
        &table->entries[INDEX_DictComp], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_GeneratorExp,
        &table->entries[INDEX_GeneratorExp],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Await,
        &table->entries[INDEX_Await], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Yield,
        &table->entries[INDEX_Yield], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_YieldFrom,
        &table->entries[INDEX_YieldFrom], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Compare,
        &table->entries[INDEX_Compare], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Call,
        &table->entries[INDEX_Call], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_FormattedValue,
        &table->entries[INDEX_FormattedValue],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_JoinedStr,
        &table->entries[INDEX_JoinedStr], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Constant,
        &table->entries[INDEX_Constant], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Attribute,
        &table->entries[INDEX_Attribute], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Subscript,
        &table->entries[INDEX_Subscript], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Starred,
        &table->entries[INDEX_Starred], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Name,
        &table->entries[INDEX_Name], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_List,
        &table->entries[INDEX_List], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Tuple,
        &table->entries[INDEX_Tuple], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_expr_context,
        &table->entries[INDEX_expr_context],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Load,
        &table->entries[INDEX_Load], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Store,
        &table->entries[INDEX_Store], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Del,
        &table->entries[INDEX_Del], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_AugLoad,
        &table->entries[INDEX_AugLoad], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_AugStore,
        &table->entries[INDEX_AugStore], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Param,
        &table->entries[INDEX_Param], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_slice,
        &table->entries[INDEX_slice], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Slice,
        &table->entries[INDEX_Slice], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_ExtSlice,
        &table->entries[INDEX_ExtSlice], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Index,
        &table->entries[INDEX_Index], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_boolop,
        &table->entries[INDEX_boolop], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_And,
        &table->entries[INDEX_And], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Or,
        &table->entries[INDEX_Or], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_operator,
        &table->entries[INDEX_operator], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Add,
        &table->entries[INDEX_Add], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Sub,
        &table->entries[INDEX_Sub], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Mult,
        &table->entries[INDEX_Mult], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_MatMult,
        &table->entries[INDEX_MatMult], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Div,
        &table->entries[INDEX_Div], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Mod,
        &table->entries[INDEX_Mod], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Pow,
        &table->entries[INDEX_Pow], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_LShift,
        &table->entries[INDEX_LShift], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_RShift,
        &table->entries[INDEX_RShift], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_BitOr,
        &table->entries[INDEX_BitOr], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_BitXor,
        &table->entries[INDEX_BitXor], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_BitAnd,
        &table->entries[INDEX_BitAnd], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_FloorDiv,
        &table->entries[INDEX_FloorDiv], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_unaryop,
        &table->entries[INDEX_unaryop], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Invert,
        &table->entries[INDEX_Invert], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Not,
        &table->entries[INDEX_Not], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_UAdd,
        &table->entries[INDEX_UAdd], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_USub,
        &table->entries[INDEX_USub], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_cmpop,
        &table->entries[INDEX_cmpop], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Eq,
        &table->entries[INDEX_Eq], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_NotEq,
        &table->entries[INDEX_NotEq], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Lt,
        &table->entries[INDEX_Lt], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_LtE,
        &table->entries[INDEX_LtE], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Gt,
        &table->entries[INDEX_Gt], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_GtE,
        &table->entries[INDEX_GtE], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_Is,
        &table->entries[INDEX_Is], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_IsNot,
        &table->entries[INDEX_IsNot], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_In,
        &table->entries[INDEX_In], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_NotIn,
        &table->entries[INDEX_NotIn], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_comprehension,
        &table->entries[INDEX_comprehension],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_excepthandler,
        &table->entries[INDEX_excepthandler],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_ExceptHandler,
        ...
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_arguments,
        &table->entries[INDEX_arguments], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_arg,
        &table->entries[INDEX_arg], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_keyword,
        &table->entries[INDEX_keyword], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_alias,
        &table->entries[INDEX_alias], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_withitem,
        &table->entries[INDEX_withitem], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_type_ignore,
        &table->entries[INDEX_type_ignore],
        (thunk_f)invoke_generic_visit_thunk, (thunk_f)call_or_fallback_thunk) <
        0)
        goto fail;
    if (initialize_entry((PyObject*)type, &PyId_visit_TypeIgnore,
        &table->entries[INDEX_TypeIgnore], (thunk_f)invoke_generic_visit_thunk,
        (thunk_f)call_or_fallback_thunk) < 0)
        goto fail;
...
static int mod_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Module_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Interactive_type_init(PyObject *self, PyObject *args, PyObject
                                 *kwargs);
static int Expression_type_init(PyObject *self, PyObject *args, PyObject
                                *kwargs);
static int FunctionType_type_init(PyObject *self, PyObject *args, PyObject
                                  *kwargs);
static int Suite_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int stmt_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int FunctionDef_type_init(PyObject *self, PyObject *args, PyObject
                                 *kwargs);
static int AsyncFunctionDef_type_init(PyObject *self, PyObject *args, PyObject
                                      *kwargs);
static int ClassDef_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Return_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Delete_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Assign_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int AugAssign_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs);
static int AnnAssign_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs);
static int For_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int AsyncFor_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int While_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int If_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int With_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int AsyncWith_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs);
static int Raise_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Try_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Assert_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Import_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int ImportFrom_type_init(PyObject *self, PyObject *args, PyObject
                                *kwargs);
static int Global_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Nonlocal_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Expr_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Pass_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Break_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Continue_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int expr_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int BoolOp_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int NamedExpr_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs);
static int BinOp_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int UnaryOp_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Lambda_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int IfExp_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Dict_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Set_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int ListComp_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int SetComp_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int DictComp_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int GeneratorExp_type_init(PyObject *self, PyObject *args, PyObject
                                  *kwargs);
static int Await_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Yield_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int YieldFrom_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs);
static int Compare_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Call_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int FormattedValue_type_init(PyObject *self, PyObject *args, PyObject
                                    *kwargs);
static int JoinedStr_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs);
static int Constant_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Attribute_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs);
static int Subscript_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs);
static int Starred_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Name_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int List_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Tuple_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int expr_context_type_init(PyObject *self, PyObject *args, PyObject
                                  *kwargs);
static int Load_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Store_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Del_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int AugLoad_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int AugStore_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Param_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int slice_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Slice_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int ExtSlice_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Index_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int boolop_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int And_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Or_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int operator_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Add_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Sub_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Mult_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int MatMult_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Div_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Mod_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Pow_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int LShift_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int RShift_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int BitOr_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int BitXor_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int BitAnd_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int FloorDiv_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int unaryop_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Invert_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Not_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int UAdd_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int USub_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int cmpop_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Eq_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int NotEq_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Lt_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int LtE_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Gt_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int GtE_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int Is_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int IsNot_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int In_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int NotIn_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int comprehension_type_init(PyObject *self, PyObject *args, PyObject
                                   *kwargs);
static int excepthandler_type_init(PyObject *self, PyObject *args, PyObject
                                   *kwargs);
static int ExceptHandler_type_init(PyObject *self, PyObject *args, PyObject
                                   *kwargs);
static int arguments_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs);
static int arg_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int keyword_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int alias_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int withitem_type_init(PyObject *self, PyObject *args, PyObject *kwargs);
static int type_ignore_type_init(PyObject *self, PyObject *args, PyObject
                                 *kwargs);
static int TypeIgnore_type_init(PyObject *self, PyObject *args, PyObject
                                *kwargs);
...
static int init_types(void)
{
    ...
    if ((node_visitor_tables = PyDict_New()) == NULL) return 0;
    if ((node_visitor_method_names = PySet_New(NULL)) == NULL) return 0;
    if (PyType_Ready(&NodeVisitor_type) < 0) return 0;
    if (PyType_Ready(&_NodeVisitorTable_Type) < 0) return 0;
    if (add_ast_fields() < 0) return 0;
    mod_type = make_type("mod", &AST_type, NULL, 0, NULL, 0, mod_type_init);
    if (!mod_type) return 0;
    if (!add_attributes(mod_type, NULL, 0)) return 0;
    if (pin_type_properties(mod_type, INDEX_mod) < 0) return 0;
    Module_type = make_type("Module", mod_type, Module_fields, 2, NULL, 0,
                            Module_type_init);
    if (!Module_type) return 0;
    if (pin_type_properties(Module_type, INDEX_Module) < 0) return 0;
    Interactive_type = make_type("Interactive", mod_type, Interactive_fields,
                                 1, NULL, 0, Interactive_type_init);
    if (!Interactive_type) return 0;
    if (pin_type_properties(Interactive_type, INDEX_Interactive) < 0) return 0;
    Expression_type = make_type("Expression", mod_type, Expression_fields, 1,
                                NULL, 0, Expression_type_init);
    if (!Expression_type) return 0;
    if (pin_type_properties(Expression_type, INDEX_Expression) < 0) return 0;
    FunctionType_type = make_type("FunctionType", mod_type,
                                  FunctionType_fields, 2, NULL, 0,
                                  FunctionType_type_init);
    if (!FunctionType_type) return 0;
    if (pin_type_properties(FunctionType_type, INDEX_FunctionType) < 0) return
        0;
    Suite_type = make_type("Suite", mod_type, Suite_fields, 1, NULL, 0,
                           Suite_type_init);
    if (!Suite_type) return 0;
    if (pin_type_properties(Suite_type, INDEX_Suite) < 0) return 0;
    stmt_type = make_type("stmt", &AST_type, NULL, 0, stmt_attributes, 4,
                          stmt_type_init);
    if (!stmt_type) return 0;
    if (!add_attributes(stmt_type, stmt_attributes, 4)) return 0;
    if (pin_type_properties(stmt_type, INDEX_stmt) < 0) return 0;
    FunctionDef_type = make_type("FunctionDef", stmt_type, FunctionDef_fields,
                                 6, NULL, 0, FunctionDef_type_init);
    if (!FunctionDef_type) return 0;
    if (pin_type_properties(FunctionDef_type, INDEX_FunctionDef) < 0) return 0;
    AsyncFunctionDef_type = make_type("AsyncFunctionDef", stmt_type,
                                      AsyncFunctionDef_fields, 6, NULL, 0,
                                      AsyncFunctionDef_type_init);
    if (!AsyncFunctionDef_type) return 0;
    if (pin_type_properties(AsyncFunctionDef_type, INDEX_AsyncFunctionDef) < 0)
        return 0;
    ClassDef_type = make_type("ClassDef", stmt_type, ClassDef_fields, 5, NULL,
                              0, ClassDef_type_init);
    if (!ClassDef_type) return 0;
    if (pin_type_properties(ClassDef_type, INDEX_ClassDef) < 0) return 0;
    Return_type = make_type("Return", stmt_type, Return_fields, 1, NULL, 0,
                            Return_type_init);
    if (!Return_type) return 0;
    if (pin_type_properties(Return_type, INDEX_Return) < 0) return 0;
    Delete_type = make_type("Delete", stmt_type, Delete_fields, 1, NULL, 0,
                            Delete_type_init);
    if (!Delete_type) return 0;
    if (pin_type_properties(Delete_type, INDEX_Delete) < 0) return 0;
    Assign_type = make_type("Assign", stmt_type, Assign_fields, 3, NULL, 0,
                            Assign_type_init);
    if (!Assign_type) return 0;
    if (pin_type_properties(Assign_type, INDEX_Assign) < 0) return 0;
    AugAssign_type = make_type("AugAssign", stmt_type, AugAssign_fields, 3,
                               NULL, 0, AugAssign_type_init);
    if (!AugAssign_type) return 0;
    if (pin_type_properties(AugAssign_type, INDEX_AugAssign) < 0) return 0;
    AnnAssign_type = make_type("AnnAssign", stmt_type, AnnAssign_fields, 4,
                               NULL, 0, AnnAssign_type_init);
    if (!AnnAssign_type) return 0;
    if (pin_type_properties(AnnAssign_type, INDEX_AnnAssign) < 0) return 0;
    For_type = make_type("For", stmt_type, For_fields, 5, NULL, 0,
                         For_type_init);
    if (!For_type) return 0;
    if (pin_type_properties(For_type, INDEX_For) < 0) return 0;
    AsyncFor_type = make_type("AsyncFor", stmt_type, AsyncFor_fields, 5, NULL,
                              0, AsyncFor_type_init);
    if (!AsyncFor_type) return 0;
    if (pin_type_properties(AsyncFor_type, INDEX_AsyncFor) < 0) return 0;
    While_type = make_type("While", stmt_type, While_fields, 3, NULL, 0,
                           While_type_init);
    if (!While_type) return 0;
    if (pin_type_properties(While_type, INDEX_While) < 0) return 0;
    If_type = make_type("If", stmt_type, If_fields, 3, NULL, 0, If_type_init);
    if (!If_type) return 0;
    if (pin_type_properties(If_type, INDEX_If) < 0) return 0;
    With_type = make_type("With", stmt_type, With_fields, 3, NULL, 0,
                          With_type_init);
    if (!With_type) return 0;
    if (pin_type_properties(With_type, INDEX_With) < 0) return 0;
    AsyncWith_type = make_type("AsyncWith", stmt_type, AsyncWith_fields, 3,
                               NULL, 0, AsyncWith_type_init);
    if (!AsyncWith_type) return 0;
    if (pin_type_properties(AsyncWith_type, INDEX_AsyncWith) < 0) return 0;
    Raise_type = make_type("Raise", stmt_type, Raise_fields, 2, NULL, 0,
                           Raise_type_init);
    if (!Raise_type) return 0;
    if (pin_type_properties(Raise_type, INDEX_Raise) < 0) return 0;
    Try_type = make_type("Try", stmt_type, Try_fields, 4, NULL, 0,
                         Try_type_init);
    if (!Try_type) return 0;
    if (pin_type_properties(Try_type, INDEX_Try) < 0) return 0;
    Assert_type = make_type("Assert", stmt_type, Assert_fields, 2, NULL, 0,
                            Assert_type_init);
    if (!Assert_type) return 0;
    if (pin_type_properties(Assert_type, INDEX_Assert) < 0) return 0;
    Import_type = make_type("Import", stmt_type, Import_fields, 1, NULL, 0,
                            Import_type_init);
    if (!Import_type) return 0;
    if (pin_type_properties(Import_type, INDEX_Import) < 0) return 0;
    ImportFrom_type = make_type("ImportFrom", stmt_type, ImportFrom_fields, 3,
                                NULL, 0, ImportFrom_type_init);
    if (!ImportFrom_type) return 0;
    if (pin_type_properties(ImportFrom_type, INDEX_ImportFrom) < 0) return 0;
    Global_type = make_type("Global", stmt_type, Global_fields, 1, NULL, 0,
                            Global_type_init);
    if (!Global_type) return 0;
    if (pin_type_properties(Global_type, INDEX_Global) < 0) return 0;
    Nonlocal_type = make_type("Nonlocal", stmt_type, Nonlocal_fields, 1, NULL,
                              0, Nonlocal_type_init);
    if (!Nonlocal_type) return 0;
    if (pin_type_properties(Nonlocal_type, INDEX_Nonlocal) < 0) return 0;
    Expr_type = make_type("Expr", stmt_type, Expr_fields, 1, NULL, 0,
                          Expr_type_init);
    if (!Expr_type) return 0;
    if (pin_type_properties(Expr_type, INDEX_Expr) < 0) return 0;
    Pass_type = make_type("Pass", stmt_type, NULL, 0, NULL, 0, Pass_type_init);
    if (!Pass_type) return 0;
    if (pin_type_properties(Pass_type, INDEX_Pass) < 0) return 0;
    Break_type = make_type("Break", stmt_type, NULL, 0, NULL, 0,
                           Break_type_init);
    if (!Break_type) return 0;
    if (pin_type_properties(Break_type, INDEX_Break) < 0) return 0;
    Continue_type = make_type("Continue", stmt_type, NULL, 0, NULL, 0,
                              Continue_type_init);
    if (!Continue_type) return 0;
    if (pin_type_properties(Continue_type, INDEX_Continue) < 0) return 0;
    expr_type = make_type("expr", &AST_type, NULL, 0, expr_attributes, 4,
                          expr_type_init);
    if (!expr_type) return 0;
    if (!add_attributes(expr_type, expr_attributes, 4)) return 0;
    if (pin_type_properties(expr_type, INDEX_expr) < 0) return 0;
    BoolOp_type = make_type("BoolOp", expr_type, BoolOp_fields, 2, NULL, 0,
                            BoolOp_type_init);
    if (!BoolOp_type) return 0;
    if (pin_type_properties(BoolOp_type, INDEX_BoolOp) < 0) return 0;
    NamedExpr_type = make_type("NamedExpr", expr_type, NamedExpr_fields, 2,
                               NULL, 0, NamedExpr_type_init);
    if (!NamedExpr_type) return 0;
    if (pin_type_properties(NamedExpr_type, INDEX_NamedExpr) < 0) return 0;
    BinOp_type = make_type("BinOp", expr_type, BinOp_fields, 3, NULL, 0,
                           BinOp_type_init);
    if (!BinOp_type) return 0;
    if (pin_type_properties(BinOp_type, INDEX_BinOp) < 0) return 0;
    UnaryOp_type = make_type("UnaryOp", expr_type, UnaryOp_fields, 2, NULL, 0,
                             UnaryOp_type_init);
    if (!UnaryOp_type) return 0;
    if (pin_type_properties(UnaryOp_type, INDEX_UnaryOp) < 0) return 0;
    Lambda_type = make_type("Lambda", expr_type, Lambda_fields, 2, NULL, 0,
                            Lambda_type_init);
    if (!Lambda_type) return 0;
    if (pin_type_properties(Lambda_type, INDEX_Lambda) < 0) return 0;
    IfExp_type = make_type("IfExp", expr_type, IfExp_fields, 3, NULL, 0,
                           IfExp_type_init);
    if (!IfExp_type) return 0;
    if (pin_type_properties(IfExp_type, INDEX_IfExp) < 0) return 0;
    Dict_type = make_type("Dict", expr_type, Dict_fields, 2, NULL, 0,
                          Dict_type_init);
    if (!Dict_type) return 0;
    if (pin_type_properties(Dict_type, INDEX_Dict) < 0) return 0;
    Set_type = make_type("Set", expr_type, Set_fields, 1, NULL, 0,
                         Set_type_init);
    if (!Set_type) return 0;
    if (pin_type_properties(Set_type, INDEX_Set) < 0) return 0;
    ListComp_type = make_type("ListComp", expr_type, ListComp_fields, 2, NULL,
                              0, ListComp_type_init);
    if (!ListComp_type) return 0;
    if (pin_type_properties(ListComp_type, INDEX_ListComp) < 0) return 0;
    SetComp_type = make_type("SetComp", expr_type, SetComp_fields, 2, NULL, 0,
                             SetComp_type_init);
    if (!SetComp_type) return 0;
    if (pin_type_properties(SetComp_type, INDEX_SetComp) < 0) return 0;
    DictComp_type = make_type("DictComp", expr_type, DictComp_fields, 3, NULL,
                              0, DictComp_type_init);
    if (!DictComp_type) return 0;
    if (pin_type_properties(DictComp_type, INDEX_DictComp) < 0) return 0;
    GeneratorExp_type = make_type("GeneratorExp", expr_type,
                                  GeneratorExp_fields, 2, NULL, 0,
                                  GeneratorExp_type_init);
    if (!GeneratorExp_type) return 0;
    if (pin_type_properties(GeneratorExp_type, INDEX_GeneratorExp) < 0) return
        0;
    Await_type = make_type("Await", expr_type, Await_fields, 1, NULL, 0,
                           Await_type_init);
    if (!Await_type) return 0;
    if (pin_type_properties(Await_type, INDEX_Await) < 0) return 0;
    Yield_type = make_type("Yield", expr_type, Yield_fields, 1, NULL, 0,
                           Yield_type_init);
    if (!Yield_type) return 0;
    if (pin_type_properties(Yield_type, INDEX_Yield) < 0) return 0;
    YieldFrom_type = make_type("YieldFrom", expr_type, YieldFrom_fields, 1,
                               NULL, 0, YieldFrom_type_init);
    if (!YieldFrom_type) return 0;
    if (pin_type_properties(YieldFrom_type, INDEX_YieldFrom) < 0) return 0;
    Compare_type = make_type("Compare", expr_type, Compare_fields, 3, NULL, 0,
                             Compare_type_init);
    if (!Compare_type) return 0;
    if (pin_type_properties(Compare_type, INDEX_Compare) < 0) return 0;
    Call_type = make_type("Call", expr_type, Call_fields, 3, NULL, 0,
                          Call_type_init);
    if (!Call_type) return 0;
    if (pin_type_properties(Call_type, INDEX_Call) < 0) return 0;
    FormattedValue_type = make_type("FormattedValue", expr_type,
                                    FormattedValue_fields, 3, NULL, 0,
                                    FormattedValue_type_init);
    if (!FormattedValue_type) return 0;
    if (pin_type_properties(FormattedValue_type, INDEX_FormattedValue) < 0)
        return 0;
    JoinedStr_type = make_type("JoinedStr", expr_type, JoinedStr_fields, 1,
                               NULL, 0, JoinedStr_type_init);
    if (!JoinedStr_type) return 0;
    if (pin_type_properties(JoinedStr_type, INDEX_JoinedStr) < 0) return 0;
    Constant_type = make_type("Constant", expr_type, Constant_fields, 2, NULL,
                              0, Constant_type_init);
    if (!Constant_type) return 0;
    if (pin_type_properties(Constant_type, INDEX_Constant) < 0) return 0;
    Attribute_type = make_type("Attribute", expr_type, Attribute_fields, 3,
                               NULL, 0, Attribute_type_init);
    if (!Attribute_type) return 0;
    if (pin_type_properties(Attribute_type, INDEX_Attribute) < 0) return 0;
    Subscript_type = make_type("Subscript", expr_type, Subscript_fields, 3,
                               NULL, 0, Subscript_type_init);
    if (!Subscript_type) return 0;
    if (pin_type_properties(Subscript_type, INDEX_Subscript) < 0) return 0;
    Starred_type = make_type("Starred", expr_type, Starred_fields, 2, NULL, 0,
                             Starred_type_init);
    if (!Starred_type) return 0;
    if (pin_type_properties(Starred_type, INDEX_Starred) < 0) return 0;
    Name_type = make_type("Name", expr_type, Name_fields, 2, NULL, 0,
                          Name_type_init);
    if (!Name_type) return 0;
    if (pin_type_properties(Name_type, INDEX_Name) < 0) return 0;
    List_type = make_type("List", expr_type, List_fields, 2, NULL, 0,
                          List_type_init);
    if (!List_type) return 0;
    if (pin_type_properties(List_type, INDEX_List) < 0) return 0;
    Tuple_type = make_type("Tuple", expr_type, Tuple_fields, 2, NULL, 0,
                           Tuple_type_init);
    if (!Tuple_type) return 0;
    if (pin_type_properties(Tuple_type, INDEX_Tuple) < 0) return 0;
    expr_context_type = make_type("expr_context", &AST_type, NULL, 0, NULL, 0,
                                  expr_context_type_init);
    if (!expr_context_type) return 0;
    if (!add_attributes(expr_context_type, NULL, 0)) return 0;
    if (pin_type_properties(expr_context_type, INDEX_expr_context) < 0) return
        0;
    Load_type = make_type("Load", expr_context_type, NULL, 0, NULL, 0,
                          Load_type_init);
    if (!Load_type) return 0;
    if (pin_type_properties(Load_type, INDEX_Load) < 0) return 0;
    Load_singleton = PyType_GenericNew(Load_type, NULL, NULL);
    if (!Load_singleton) return 0;
    ((AST_object*)Load_singleton)->method_index = INDEX_Load;
    Store_type = make_type("Store", expr_context_type, NULL, 0, NULL, 0,
                           Store_type_init);
    if (!Store_type) return 0;
    if (pin_type_properties(Store_type, INDEX_Store) < 0) return 0;
    Store_singleton = PyType_GenericNew(Store_type, NULL, NULL);
    if (!Store_singleton) return 0;
    ((AST_object*)Store_singleton)->method_index = INDEX_Store;
    Del_type = make_type("Del", expr_context_type, NULL, 0, NULL, 0,
                         Del_type_init);
    if (!Del_type) return 0;
    if (pin_type_properties(Del_type, INDEX_Del) < 0) return 0;
    Del_singleton = PyType_GenericNew(Del_type, NULL, NULL);
    if (!Del_singleton) return 0;
    ((AST_object*)Del_singleton)->method_index = INDEX_Del;
    AugLoad_type = make_type("AugLoad", expr_context_type, NULL, 0, NULL, 0,
                             AugLoad_type_init);
    if (!AugLoad_type) return 0;
    if (pin_type_properties(AugLoad_type, INDEX_AugLoad) < 0) return 0;
    AugLoad_singleton = PyType_GenericNew(AugLoad_type, NULL, NULL);
    if (!AugLoad_singleton) return 0;
    ((AST_object*)AugLoad_singleton)->method_index = INDEX_AugLoad;
    AugStore_type = make_type("AugStore", expr_context_type, NULL, 0, NULL, 0,
                              AugStore_type_init);
    if (!AugStore_type) return 0;
    if (pin_type_properties(AugStore_type, INDEX_AugStore) < 0) return 0;
    AugStore_singleton = PyType_GenericNew(AugStore_type, NULL, NULL);
    if (!AugStore_singleton) return 0;
    ((AST_object*)AugStore_singleton)->method_index = INDEX_AugStore;
    Param_type = make_type("Param", expr_context_type, NULL, 0, NULL, 0,
                           Param_type_init);
    if (!Param_type) return 0;
    if (pin_type_properties(Param_type, INDEX_Param) < 0) return 0;
    Param_singleton = PyType_GenericNew(Param_type, NULL, NULL);
    if (!Param_singleton) return 0;
    ((AST_object*)Param_singleton)->method_index = INDEX_Param;
    slice_type = make_type("slice", &AST_type, NULL, 0, NULL, 0,
                           slice_type_init);
    if (!slice_type) return 0;
    if (!add_attributes(slice_type, NULL, 0)) return 0;
    if (pin_type_properties(slice_type, INDEX_slice) < 0) return 0;
    Slice_type = make_type("Slice", slice_type, Slice_fields, 3, NULL, 0,
                           Slice_type_init);
    if (!Slice_type) return 0;
    if (pin_type_properties(Slice_type, INDEX_Slice) < 0) return 0;
    ExtSlice_type = make_type("ExtSlice", slice_type, ExtSlice_fields, 1, NULL,
                              0, ExtSlice_type_init);
    if (!ExtSlice_type) return 0;
    if (pin_type_properties(ExtSlice_type, INDEX_ExtSlice) < 0) return 0;
    Index_type = make_type("Index", slice_type, Index_fields, 1, NULL, 0,
                           Index_type_init);
    if (!Index_type) return 0;
    if (pin_type_properties(Index_type, INDEX_Index) < 0) return 0;
    boolop_type = make_type("boolop", &AST_type, NULL, 0, NULL, 0,
                            boolop_type_init);
    if (!boolop_type) return 0;
    if (!add_attributes(boolop_type, NULL, 0)) return 0;
    if (pin_type_properties(boolop_type, INDEX_boolop) < 0) return 0;
    And_type = make_type("And", boolop_type, NULL, 0, NULL, 0, And_type_init);
    if (!And_type) return 0;
    if (pin_type_properties(And_type, INDEX_And) < 0) return 0;
    And_singleton = PyType_GenericNew(And_type, NULL, NULL);
    if (!And_singleton) return 0;
    ((AST_object*)And_singleton)->method_index = INDEX_And;
    Or_type = make_type("Or", boolop_type, NULL, 0, NULL, 0, Or_type_init);
    if (!Or_type) return 0;
    if (pin_type_properties(Or_type, INDEX_Or) < 0) return 0;
    Or_singleton = PyType_GenericNew(Or_type, NULL, NULL);
    if (!Or_singleton) return 0;
    ((AST_object*)Or_singleton)->method_index = INDEX_Or;
    operator_type = make_type("operator", &AST_type, NULL, 0, NULL, 0,
                              operator_type_init);
    if (!operator_type) return 0;
    if (!add_attributes(operator_type, NULL, 0)) return 0;
    if (pin_type_properties(operator_type, INDEX_operator) < 0) return 0;
    Add_type = make_type("Add", operator_type, NULL, 0, NULL, 0, Add_type_init);
    if (!Add_type) return 0;
    if (pin_type_properties(Add_type, INDEX_Add) < 0) return 0;
    Add_singleton = PyType_GenericNew(Add_type, NULL, NULL);
    if (!Add_singleton) return 0;
    ((AST_object*)Add_singleton)->method_index = INDEX_Add;
    Sub_type = make_type("Sub", operator_type, NULL, 0, NULL, 0, Sub_type_init);
    if (!Sub_type) return 0;
    if (pin_type_properties(Sub_type, INDEX_Sub) < 0) return 0;
    Sub_singleton = PyType_GenericNew(Sub_type, NULL, NULL);
    if (!Sub_singleton) return 0;
    ((AST_object*)Sub_singleton)->method_index = INDEX_Sub;
    Mult_type = make_type("Mult", operator_type, NULL, 0, NULL, 0,
                          Mult_type_init);
    if (!Mult_type) return 0;
    if (pin_type_properties(Mult_type, INDEX_Mult) < 0) return 0;
    Mult_singleton = PyType_GenericNew(Mult_type, NULL, NULL);
    if (!Mult_singleton) return 0;
    ((AST_object*)Mult_singleton)->method_index = INDEX_Mult;
    MatMult_type = make_type("MatMult", operator_type, NULL, 0, NULL, 0,
                             MatMult_type_init);
    if (!MatMult_type) return 0;
    if (pin_type_properties(MatMult_type, INDEX_MatMult) < 0) return 0;
    MatMult_singleton = PyType_GenericNew(MatMult_type, NULL, NULL);
    if (!MatMult_singleton) return 0;
    ((AST_object*)MatMult_singleton)->method_index = INDEX_MatMult;
    Div_type = make_type("Div", operator_type, NULL, 0, NULL, 0, Div_type_init);
    if (!Div_type) return 0;
    if (pin_type_properties(Div_type, INDEX_Div) < 0) return 0;
    Div_singleton = PyType_GenericNew(Div_type, NULL, NULL);
    if (!Div_singleton) return 0;
    ((AST_object*)Div_singleton)->method_index = INDEX_Div;
    Mod_type = make_type("Mod", operator_type, NULL, 0, NULL, 0, Mod_type_init);
    if (!Mod_type) return 0;
    if (pin_type_properties(Mod_type, INDEX_Mod) < 0) return 0;
    Mod_singleton = PyType_GenericNew(Mod_type, NULL, NULL);
    if (!Mod_singleton) return 0;
    ((AST_object*)Mod_singleton)->method_index = INDEX_Mod;
    Pow_type = make_type("Pow", operator_type, NULL, 0, NULL, 0, Pow_type_init);
    if (!Pow_type) return 0;
    if (pin_type_properties(Pow_type, INDEX_Pow) < 0) return 0;
    Pow_singleton = PyType_GenericNew(Pow_type, NULL, NULL);
    if (!Pow_singleton) return 0;
    ((AST_object*)Pow_singleton)->method_index = INDEX_Pow;
    LShift_type = make_type("LShift", operator_type, NULL, 0, NULL, 0,
                            LShift_type_init);
    if (!LShift_type) return 0;
    if (pin_type_properties(LShift_type, INDEX_LShift) < 0) return 0;
    LShift_singleton = PyType_GenericNew(LShift_type, NULL, NULL);
    if (!LShift_singleton) return 0;
    ((AST_object*)LShift_singleton)->method_index = INDEX_LShift;
    RShift_type = make_type("RShift", operator_type, NULL, 0, NULL, 0,
                            RShift_type_init);
    if (!RShift_type) return 0;
    if (pin_type_properties(RShift_type, INDEX_RShift) < 0) return 0;
    RShift_singleton = PyType_GenericNew(RShift_type, NULL, NULL);
    if (!RShift_singleton) return 0;
    ((AST_object*)RShift_singleton)->method_index = INDEX_RShift;
    BitOr_type = make_type("BitOr", operator_type, NULL, 0, NULL, 0,
                           BitOr_type_init);
    if (!BitOr_type) return 0;
    if (pin_type_properties(BitOr_type, INDEX_BitOr) < 0) return 0;
    BitOr_singleton = PyType_GenericNew(BitOr_type, NULL, NULL);
    if (!BitOr_singleton) return 0;
    ((AST_object*)BitOr_singleton)->method_index = INDEX_BitOr;
    BitXor_type = make_type("BitXor", operator_type, NULL, 0, NULL, 0,
                            BitXor_type_init);
    if (!BitXor_type) return 0;
    if (pin_type_properties(BitXor_type, INDEX_BitXor) < 0) return 0;
    BitXor_singleton = PyType_GenericNew(BitXor_type, NULL, NULL);
    if (!BitXor_singleton) return 0;
    ((AST_object*)BitXor_singleton)->method_index = INDEX_BitXor;
    BitAnd_type = make_type("BitAnd", operator_type, NULL, 0, NULL, 0,
                            BitAnd_type_init);
    if (!BitAnd_type) return 0;
    if (pin_type_properties(BitAnd_type, INDEX_BitAnd) < 0) return 0;
    BitAnd_singleton = PyType_GenericNew(BitAnd_type, NULL, NULL);
    if (!BitAnd_singleton) return 0;
    ((AST_object*)BitAnd_singleton)->method_index = INDEX_BitAnd;
    FloorDiv_type = make_type("FloorDiv", operator_type, NULL, 0, NULL, 0,
                              FloorDiv_type_init);
    if (!FloorDiv_type) return 0;
    if (pin_type_properties(FloorDiv_type, INDEX_FloorDiv) < 0) return 0;
    FloorDiv_singleton = PyType_GenericNew(FloorDiv_type, NULL, NULL);
    if (!FloorDiv_singleton) return 0;
    ((AST_object*)FloorDiv_singleton)->method_index = INDEX_FloorDiv;
    unaryop_type = make_type("unaryop", &AST_type, NULL, 0, NULL, 0,
                             unaryop_type_init);
    if (!unaryop_type) return 0;
    if (!add_attributes(unaryop_type, NULL, 0)) return 0;
    if (pin_type_properties(unaryop_type, INDEX_unaryop) < 0) return 0;
    Invert_type = make_type("Invert", unaryop_type, NULL, 0, NULL, 0,
                            Invert_type_init);
    if (!Invert_type) return 0;
    if (pin_type_properties(Invert_type, INDEX_Invert) < 0) return 0;
    Invert_singleton = PyType_GenericNew(Invert_type, NULL, NULL);
    if (!Invert_singleton) return 0;
    ((AST_object*)Invert_singleton)->method_index = INDEX_Invert;
    Not_type = make_type("Not", unaryop_type, NULL, 0, NULL, 0, Not_type_init);
    if (!Not_type) return 0;
    if (pin_type_properties(Not_type, INDEX_Not) < 0) return 0;
    Not_singleton = PyType_GenericNew(Not_type, NULL, NULL);
    if (!Not_singleton) return 0;
    ((AST_object*)Not_singleton)->method_index = INDEX_Not;
    UAdd_type = make_type("UAdd", unaryop_type, NULL, 0, NULL, 0,
                          UAdd_type_init);
    if (!UAdd_type) return 0;
    if (pin_type_properties(UAdd_type, INDEX_UAdd) < 0) return 0;
    UAdd_singleton = PyType_GenericNew(UAdd_type, NULL, NULL);
    if (!UAdd_singleton) return 0;
    ((AST_object*)UAdd_singleton)->method_index = INDEX_UAdd;
    USub_type = make_type("USub", unaryop_type, NULL, 0, NULL, 0,
                          USub_type_init);
    if (!USub_type) return 0;
    if (pin_type_properties(USub_type, INDEX_USub) < 0) return 0;
    USub_singleton = PyType_GenericNew(USub_type, NULL, NULL);
    if (!USub_singleton) return 0;
    ((AST_object*)USub_singleton)->method_index = INDEX_USub;
    cmpop_type = make_type("cmpop", &AST_type, NULL, 0, NULL, 0,
                           cmpop_type_init);
    if (!cmpop_type) return 0;
    if (!add_attributes(cmpop_type, NULL, 0)) return 0;
    if (pin_type_properties(cmpop_type, INDEX_cmpop) < 0) return 0;
    Eq_type = make_type("Eq", cmpop_type, NULL, 0, NULL, 0, Eq_type_init);
    if (!Eq_type) return 0;
    if (pin_type_properties(Eq_type, INDEX_Eq) < 0) return 0;
    Eq_singleton = PyType_GenericNew(Eq_type, NULL, NULL);
    if (!Eq_singleton) return 0;
    ((AST_object*)Eq_singleton)->method_index = INDEX_Eq;
    NotEq_type = make_type("NotEq", cmpop_type, NULL, 0, NULL, 0,
                           NotEq_type_init);
    if (!NotEq_type) return 0;
    if (pin_type_properties(NotEq_type, INDEX_NotEq) < 0) return 0;
    NotEq_singleton = PyType_GenericNew(NotEq_type, NULL, NULL);
    if (!NotEq_singleton) return 0;
    ((AST_object*)NotEq_singleton)->method_index = INDEX_NotEq;
    Lt_type = make_type("Lt", cmpop_type, NULL, 0, NULL, 0, Lt_type_init);
    if (!Lt_type) return 0;
    if (pin_type_properties(Lt_type, INDEX_Lt) < 0) return 0;
    Lt_singleton = PyType_GenericNew(Lt_type, NULL, NULL);
    if (!Lt_singleton) return 0;
    ((AST_object*)Lt_singleton)->method_index = INDEX_Lt;
    LtE_type = make_type("LtE", cmpop_type, NULL, 0, NULL, 0, LtE_type_init);
    if (!LtE_type) return 0;
    if (pin_type_properties(LtE_type, INDEX_LtE) < 0) return 0;
    LtE_singleton = PyType_GenericNew(LtE_type, NULL, NULL);
    if (!LtE_singleton) return 0;
    ((AST_object*)LtE_singleton)->method_index = INDEX_LtE;
    Gt_type = make_type("Gt", cmpop_type, NULL, 0, NULL, 0, Gt_type_init);
    if (!Gt_type) return 0;
    if (pin_type_properties(Gt_type, INDEX_Gt) < 0) return 0;
    Gt_singleton = PyType_GenericNew(Gt_type, NULL, NULL);
    if (!Gt_singleton) return 0;
    ((AST_object*)Gt_singleton)->method_index = INDEX_Gt;
    GtE_type = make_type("GtE", cmpop_type, NULL, 0, NULL, 0, GtE_type_init);
    if (!GtE_type) return 0;
    if (pin_type_properties(GtE_type, INDEX_GtE) < 0) return 0;
    GtE_singleton = PyType_GenericNew(GtE_type, NULL, NULL);
    if (!GtE_singleton) return 0;
    ((AST_object*)GtE_singleton)->method_index = INDEX_GtE;
    Is_type = make_type("Is", cmpop_type, NULL, 0, NULL, 0, Is_type_init);
    if (!Is_type) return 0;
    if (pin_type_properties(Is_type, INDEX_Is) < 0) return 0;
    Is_singleton = PyType_GenericNew(Is_type, NULL, NULL);
    if (!Is_singleton) return 0;
    ((AST_object*)Is_singleton)->method_index = INDEX_Is;
    IsNot_type = make_type("IsNot", cmpop_type, NULL, 0, NULL, 0,
                           IsNot_type_init);
    if (!IsNot_type) return 0;
    if (pin_type_properties(IsNot_type, INDEX_IsNot) < 0) return 0;
    IsNot_singleton = PyType_GenericNew(IsNot_type, NULL, NULL);
    if (!IsNot_singleton) return 0;
    ((AST_object*)IsNot_singleton)->method_index = INDEX_IsNot;
    In_type = make_type("In", cmpop_type, NULL, 0, NULL, 0, In_type_init);
    if (!In_type) return 0;
    if (pin_type_properties(In_type, INDEX_In) < 0) return 0;
    In_singleton = PyType_GenericNew(In_type, NULL, NULL);
    if (!In_singleton) return 0;
    ((AST_object*)In_singleton)->method_index = INDEX_In;
    NotIn_type = make_type("NotIn", cmpop_type, NULL, 0, NULL, 0,
                           NotIn_type_init);
    if (!NotIn_type) return 0;
    if (pin_type_properties(NotIn_type, INDEX_NotIn) < 0) return 0;
    NotIn_singleton = PyType_GenericNew(NotIn_type, NULL, NULL);
    if (!NotIn_singleton) return 0;
    ((AST_object*)NotIn_singleton)->method_index = INDEX_NotIn;
    comprehension_type = make_type("comprehension", &AST_type,
                                   comprehension_fields, 4, NULL,
                                   0,comprehension_type_init);
    if (!comprehension_type) return 0;
    if (!add_attributes(comprehension_type, NULL, 0)) return 0;
    if (pin_type_properties(comprehension_type, INDEX_comprehension) < 0)
        return 0;
    excepthandler_type = make_type("excepthandler", &AST_type, NULL, 0,
                                   excepthandler_attributes, 4,
                                   excepthandler_type_init);
    if (!excepthandler_type) return 0;
    if (!add_attributes(excepthandler_type, excepthandler_attributes, 4))
        return 0;
    if (pin_type_properties(excepthandler_type, INDEX_excepthandler) < 0)
        return 0;
    ExceptHandler_type = make_type("ExceptHandler", excepthandler_type,
                                   ExceptHandler_fields, 3, NULL, 0,
                                   ExceptHandler_type_init);
    if (!ExceptHandler_type) return 0;
    if (pin_type_properties(ExceptHandler_type, INDEX_ExceptHandler) < 0)
        return 0;
    arguments_type = make_type("arguments", &AST_type, arguments_fields, 7,
                               NULL, 0,arguments_type_init);
    if (!arguments_type) return 0;
    if (!add_attributes(arguments_type, NULL, 0)) return 0;
    if (pin_type_properties(arguments_type, INDEX_arguments) < 0) return 0;
    arg_type = make_type("arg", &AST_type, arg_fields, 3, arg_attributes,
                         4,arg_type_init);
    if (!arg_type) return 0;
    if (!add_attributes(arg_type, arg_attributes, 4)) return 0;
    if (pin_type_properties(arg_type, INDEX_arg) < 0) return 0;
    keyword_type = make_type("keyword", &AST_type, keyword_fields, 2, NULL,
                             0,keyword_type_init);
    if (!keyword_type) return 0;
    if (!add_attributes(keyword_type, NULL, 0)) return 0;
    if (pin_type_properties(keyword_type, INDEX_keyword) < 0) return 0;
    alias_type = make_type("alias", &AST_type, alias_fields, 2, NULL,
                           0,alias_type_init);
    if (!alias_type) return 0;
    if (!add_attributes(alias_type, NULL, 0)) return 0;
    if (pin_type_properties(alias_type, INDEX_alias) < 0) return 0;
    withitem_type = make_type("withitem", &AST_type, withitem_fields, 2, NULL,
                              0,withitem_type_init);
    if (!withitem_type) return 0;
    if (!add_attributes(withitem_type, NULL, 0)) return 0;
    if (pin_type_properties(withitem_type, INDEX_withitem) < 0) return 0;
    type_ignore_type = make_type("type_ignore", &AST_type, NULL, 0, NULL, 0,
                                 type_ignore_type_init);
    if (!type_ignore_type) return 0;
    if (!add_attributes(type_ignore_type, NULL, 0)) return 0;
    if (pin_type_properties(type_ignore_type, INDEX_type_ignore) < 0) return 0;
    TypeIgnore_type = make_type("TypeIgnore", type_ignore_type,
                                TypeIgnore_fields, 2, NULL, 0,
                                TypeIgnore_type_init);
    if (!TypeIgnore_type) return 0;
    if (pin_type_properties(TypeIgnore_type, INDEX_TypeIgnore) < 0) return 0;
    initialized = 1;
    return 1;
}
static void module_free(void *m) {
    Py_CLEAR(node_visitor_tables);
    Py_CLEAR(node_visitor_method_names);
    for (Py_ssize_t i = 0; i < NUM_METHODS; ++i) {
        Py_CLEAR(NODE_TYPES_PROPS[i].type);
        Py_CLEAR(NODE_TYPES_PROPS[i].field_descriptors);
    }
    initialized = 0;
}

static int mod_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)mod_type ? INDEX_mod : -1;
    return 0;
}
static int Module_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = mod_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Module_type ? INDEX_Module : -1;
    return 0;
}
static int Interactive_type_init(PyObject *self, PyObject *args, PyObject
                                 *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Interactive_type ? INDEX_Interactive :
                -1;
    return 0;
}
static int Expression_type_init(PyObject *self, PyObject *args, PyObject
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Expression_type ? INDEX_Expression : -1;
    return 0;
}
static int FunctionType_type_init(PyObject *self, PyObject *args, PyObject
                                  *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)FunctionType_type ? INDEX_FunctionType
                : -1;
    return 0;
}
static int Suite_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Suite_type ? INDEX_Suite : -1;
    return 0;
}
static int stmt_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)stmt_type ? INDEX_stmt : -1;
    return 0;
}
static int FunctionDef_type_init(PyObject *self, PyObject *args, PyObject
                                 *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)FunctionDef_type ? INDEX_FunctionDef :
                -1;
    return 0;
}
static int AsyncFunctionDef_type_init(PyObject *self, PyObject *args, PyObject
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)AsyncFunctionDef_type ?
                INDEX_AsyncFunctionDef : -1;
    return 0;
}
static int ClassDef_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)ClassDef_type ? INDEX_ClassDef : -1;
    return 0;
}
static int Return_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Return_type ? INDEX_Return : -1;
    return 0;
}
static int Delete_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Delete_type ? INDEX_Delete : -1;
    return 0;
}
static int Assign_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Assign_type ? INDEX_Assign : -1;
    return 0;
}
static int AugAssign_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)AugAssign_type ? INDEX_AugAssign : -1;
    return 0;
}
static int AnnAssign_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)AnnAssign_type ? INDEX_AnnAssign : -1;
    return 0;
}
static int For_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)For_type ? INDEX_For : -1;
    return 0;
}
static int AsyncFor_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)AsyncFor_type ? INDEX_AsyncFor : -1;
    return 0;
}
static int While_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)While_type ? INDEX_While : -1;
    return 0;
}
static int If_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)If_type ? INDEX_If : -1;
    return 0;
}
static int With_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)With_type ? INDEX_With : -1;
    return 0;
}
static int AsyncWith_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)AsyncWith_type ? INDEX_AsyncWith : -1;
    return 0;
}
static int Raise_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Raise_type ? INDEX_Raise : -1;
    return 0;
}
static int Try_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Try_type ? INDEX_Try : -1;
    return 0;
}
static int Assert_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Assert_type ? INDEX_Assert : -1;
    return 0;
}
static int Import_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Import_type ? INDEX_Import : -1;
    return 0;
}
static int ImportFrom_type_init(PyObject *self, PyObject *args, PyObject
                                *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)ImportFrom_type ? INDEX_ImportFrom : -1;
    return 0;
}
static int Global_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Global_type ? INDEX_Global : -1;
    return 0;
}
static int Nonlocal_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Nonlocal_type ? INDEX_Nonlocal : -1;
    return 0;
}
static int Expr_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Expr_type ? INDEX_Expr : -1;
    return 0;
}
static int Pass_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Pass_type ? INDEX_Pass : -1;
    return 0;
}
static int Break_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = stmt_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Break_type ? INDEX_Break : -1;
    return 0;
}
static int Continue_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Continue_type ? INDEX_Continue : -1;
    return 0;
}
static int expr_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
...
static int BoolOp_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)BoolOp_type ? INDEX_BoolOp : -1;
    return 0;
}
static int NamedExpr_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)NamedExpr_type ? INDEX_NamedExpr : -1;
    return 0;
}
static int BinOp_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)BinOp_type ? INDEX_BinOp : -1;
    return 0;
}
static int UnaryOp_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)UnaryOp_type ? INDEX_UnaryOp : -1;
    return 0;
}
static int Lambda_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Lambda_type ? INDEX_Lambda : -1;
    return 0;
}
static int IfExp_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)IfExp_type ? INDEX_IfExp : -1;
    return 0;
}
static int Dict_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Dict_type ? INDEX_Dict : -1;
    return 0;
}
static int Set_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Set_type ? INDEX_Set : -1;
    return 0;
}
static int ListComp_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)ListComp_type ? INDEX_ListComp : -1;
    return 0;
}
static int SetComp_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)SetComp_type ? INDEX_SetComp : -1;
    return 0;
}
static int DictComp_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)DictComp_type ? INDEX_DictComp : -1;
    return 0;
}
static int GeneratorExp_type_init(PyObject *self, PyObject *args, PyObject
                                  *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)GeneratorExp_type ? INDEX_GeneratorExp
                : -1;
    return 0;
}
static int Await_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Await_type ? INDEX_Await : -1;
    return 0;
}
static int Yield_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Yield_type ? INDEX_Yield : -1;
    return 0;
}
static int YieldFrom_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)YieldFrom_type ? INDEX_YieldFrom : -1;
    return 0;
}
static int Compare_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Compare_type ? INDEX_Compare : -1;
    return 0;
}
static int Call_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Call_type ? INDEX_Call : -1;
    return 0;
}
static int FormattedValue_type_init(PyObject *self, PyObject *args, PyObject
                                    *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)FormattedValue_type ?
                INDEX_FormattedValue : -1;
    return 0;
}
static int JoinedStr_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)JoinedStr_type ? INDEX_JoinedStr : -1;
    return 0;
}
static int Constant_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Constant_type ? INDEX_Constant : -1;
    return 0;
}
static int Attribute_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Attribute_type ? INDEX_Attribute : -1;
    return 0;
}
static int Subscript_type_init(PyObject *self, PyObject *args, PyObject
                               *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Subscript_type ? INDEX_Subscript : -1;
    return 0;
}
static int Starred_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Starred_type ? INDEX_Starred : -1;
    return 0;
}
static int Name_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Name_type ? INDEX_Name : -1;
    return 0;
}
static int List_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)List_type ? INDEX_List : -1;
    return 0;
}
static int Tuple_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Tuple_type ? INDEX_Tuple : -1;
    return 0;
}
static int expr_context_type_init(PyObject *self, PyObject *args, PyObject
                                  *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)expr_context_type ? INDEX_expr_context
                : -1;
    return 0;
}
static int Load_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_context_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Load_type ? INDEX_Load : -1;
    return 0;
}
static int Store_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_context_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Store_type ? INDEX_Store : -1;
    return 0;
}
static int Del_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_context_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Del_type ? INDEX_Del : -1;
    return 0;
}
static int AugLoad_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_context_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)AugLoad_type ? INDEX_AugLoad : -1;
    return 0;
}
static int AugStore_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)AugStore_type ? INDEX_AugStore : -1;
    return 0;
}
static int Param_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = expr_context_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Param_type ? INDEX_Param : -1;
    return 0;
}
static int slice_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)slice_type ? INDEX_slice : -1;
    return 0;
}
static int Slice_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = slice_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Slice_type ? INDEX_Slice : -1;
    return 0;
...
static int ExtSlice_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)ExtSlice_type ? INDEX_ExtSlice : -1;
    return 0;
}
static int Index_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = slice_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Index_type ? INDEX_Index : -1;
    return 0;
}
static int boolop_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
...
static int And_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = boolop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)And_type ? INDEX_And : -1;
    return 0;
}
static int Or_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = boolop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Or_type ? INDEX_Or : -1;
    return 0;
}
static int operator_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)operator_type ? INDEX_operator : -1;
    return 0;
}
static int Add_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Add_type ? INDEX_Add : -1;
    return 0;
}
static int Sub_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Sub_type ? INDEX_Sub : -1;
    return 0;
}
static int Mult_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Mult_type ? INDEX_Mult : -1;
    return 0;
}
static int MatMult_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)MatMult_type ? INDEX_MatMult : -1;
    return 0;
}
static int Div_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Div_type ? INDEX_Div : -1;
    return 0;
}
static int Mod_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
...
static int Pow_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Pow_type ? INDEX_Pow : -1;
    return 0;
}
static int LShift_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)LShift_type ? INDEX_LShift : -1;
    return 0;
}
static int RShift_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)RShift_type ? INDEX_RShift : -1;
    return 0;
}
static int BitOr_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)BitOr_type ? INDEX_BitOr : -1;
    return 0;
}
static int BitXor_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)BitXor_type ? INDEX_BitXor : -1;
    return 0;
}
static int BitAnd_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = operator_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)BitAnd_type ? INDEX_BitAnd : -1;
    return 0;
}
static int FloorDiv_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)FloorDiv_type ? INDEX_FloorDiv : -1;
    return 0;
}
static int unaryop_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
...
static int Invert_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = unaryop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Invert_type ? INDEX_Invert : -1;
    return 0;
}
static int Not_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = unaryop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Not_type ? INDEX_Not : -1;
    return 0;
}
static int UAdd_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = unaryop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)UAdd_type ? INDEX_UAdd : -1;
    return 0;
}
static int USub_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = unaryop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)USub_type ? INDEX_USub : -1;
    return 0;
}
static int cmpop_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)cmpop_type ? INDEX_cmpop : -1;
    return 0;
}
static int Eq_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Eq_type ? INDEX_Eq : -1;
    return 0;
}
static int NotEq_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)NotEq_type ? INDEX_NotEq : -1;
    return 0;
}
static int Lt_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Lt_type ? INDEX_Lt : -1;
    return 0;
}
static int LtE_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)LtE_type ? INDEX_LtE : -1;
    return 0;
}
static int Gt_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Gt_type ? INDEX_Gt : -1;
    return 0;
}
static int GtE_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)GtE_type ? INDEX_GtE : -1;
    return 0;
}
static int Is_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)Is_type ? INDEX_Is : -1;
    return 0;
}
static int IsNot_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)IsNot_type ? INDEX_IsNot : -1;
    return 0;
}
static int In_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)In_type ? INDEX_In : -1;
    return 0;
}
static int NotIn_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = cmpop_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)NotIn_type ? INDEX_NotIn : -1;
    return 0;
}
static int comprehension_type_init(PyObject *self, PyObject *args, PyObject
                                   *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)comprehension_type ?
                INDEX_comprehension : -1;
    return 0;
}
static int excepthandler_type_init(PyObject *self, PyObject *args, PyObject
                                   *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)excepthandler_type ?
                INDEX_excepthandler : -1;
    return 0;
}
static int ExceptHandler_type_init(PyObject *self, PyObject *args, PyObject
                                   *kwargs) {
    int ok = excepthandler_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)ExceptHandler_type ?
                INDEX_ExceptHandler : -1;
...
static int arguments_type_init(PyObject *self, PyObject *args, PyObject
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)arguments_type ? INDEX_arguments : -1;
    return 0;
}
static int arg_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)arg_type ? INDEX_arg : -1;
    return 0;
}
static int keyword_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)keyword_type ? INDEX_keyword : -1;
    return 0;
}
static int alias_type_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    int ok = ast_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)alias_type ? INDEX_alias : -1;
    return 0;
}
static int withitem_type_init(PyObject *self, PyObject *args, PyObject *kwargs)
                              {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)withitem_type ? INDEX_withitem : -1;
    return 0;
}
static int type_ignore_type_init(PyObject *self, PyObject *args, PyObject
                                 *kwargs) {
    ...
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)type_ignore_type ? INDEX_type_ignore :
                -1;
    return 0;
}
static int TypeIgnore_type_init(PyObject *self, PyObject *args, PyObject
                                *kwargs) {
    int ok = type_ignore_type_init(self, args, kwargs);
    if (ok < 0) return ok;
    ((AST_object*)self)->method_index =
        Py_TYPE(self) == (PyTypeObject*)TypeIgnore_type ? INDEX_TypeIgnore : -1;
    return 0;
}
...
ast2obj_mod(void* _o)
{
    ...
    case Module_kind:
        ...
        ((AST_object*)result)->method_index = INDEX_Module;
    ...
    case Interactive_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Interactive;
    ...
    case Expression_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Expression;
    ...
    case FunctionType_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_FunctionType;
    ...
    case Suite_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Suite;
...
ast2obj_stmt(void* _o)
{
    ...
    case FunctionDef_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_FunctionDef;
    ...
    case AsyncFunctionDef_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_AsyncFunctionDef;
    ...
    case ClassDef_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_ClassDef;
    ...
    case Return_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Return;
    ...
    case Delete_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Delete;
    ...
    case Assign_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Assign;
    ...
    case AugAssign_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_AugAssign;
    ...
    case AnnAssign_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_AnnAssign;
    ...
    case For_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_For;
    ...
    case AsyncFor_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_AsyncFor;
    ...
    case While_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_While;
    ...
    case If_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_If;
    ...
    case With_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_With;
    ...
    case AsyncWith_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_AsyncWith;
    ...
    case Raise_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Raise;
    ...
    case Try_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Try;
    ...
    case Assert_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Assert;
    ...
    case Import_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Import;
    ...
    case ImportFrom_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_ImportFrom;
    ...
    case Global_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Global;
    ...
    case Nonlocal_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Nonlocal;
    ...
    case Expr_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Expr;
    ...
    case Pass_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Pass;
        break;
    case Break_kind:
        result = PyType_GenericNew(Break_type, NULL, NULL);
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Break;
        break;
    case Continue_kind:
        result = PyType_GenericNew(Continue_type, NULL, NULL);
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Continue;
        break;
    }
...
ast2obj_expr(void* _o)
{
    ...
    case BoolOp_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_BoolOp;
    ...
    case NamedExpr_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_NamedExpr;
    ...
    case BinOp_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_BinOp;
    ...
    case UnaryOp_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_UnaryOp;
    ...
    case Lambda_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Lambda;
    ...
    case IfExp_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_IfExp;
    ...
    case Dict_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Dict;
    ...
    case Set_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Set;
    ...
    case ListComp_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_ListComp;
    ...
    case SetComp_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_SetComp;
    ...
    case DictComp_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_DictComp;
    ...
    case GeneratorExp_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_GeneratorExp;
    ...
    case Await_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Await;
    ...
    case Yield_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Yield;
    ...
    case YieldFrom_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_YieldFrom;
    ...
    case Compare_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Compare;
    ...
    case Call_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Call;
    ...
    case FormattedValue_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_FormattedValue;
    ...
    case JoinedStr_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_JoinedStr;
    ...
    case Constant_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Constant;
    ...
    case Attribute_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Attribute;
    ...
    case Subscript_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Subscript;
    ...
    case Starred_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Starred;
    ...
    case Name_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Name;
    ...
    case List_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_List;
    ...
    case Tuple_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Tuple;
...
ast2obj_slice(void* _o)
{
    ...
    case Slice_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Slice;
    ...
    case ExtSlice_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_ExtSlice;
    ...
    case Index_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_Index;
...
ast2obj_comprehension(void* _o)
{
    ...
    ((AST_object*)result)->method_index = INDEX_comprehension;
...
ast2obj_excepthandler(void* _o)
{
    ...
    case ExceptHandler_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_ExceptHandler;
...
ast2obj_arguments(void* _o)
{
    ...
    if (!result) return NULL;
    ((AST_object*)result)->method_index = INDEX_arguments;
...
ast2obj_arg(void* _o)
{
    ...
    if (!result) return NULL;
    ((AST_object*)result)->method_index = INDEX_arg;
...
ast2obj_keyword(void* _o)
{
    ...
    if (!result) return NULL;
    ((AST_object*)result)->method_index = INDEX_keyword;
    value = ast2obj_identifier(o->arg);
    if (!value) goto failed;
    if (_PyObject_SetAttrId(result, &PyId_arg, value) == -1)
        goto failed;
...
ast2obj_alias(void* _o)
{
    ...
    if (!result) return NULL;
    ((AST_object*)result)->method_index = INDEX_alias;
...
ast2obj_withitem(void* _o)
{
    ...
    if (!result) return NULL;
    ((AST_object*)result)->method_index = INDEX_withitem;
...
ast2obj_type_ignore(void* _o)
{
    ...
    case TypeIgnore_kind:
        ...
        if (!result) goto failed;
        ((AST_object*)result)->method_index = INDEX_TypeIgnore;
...
PyInit__ast(void)
{
    ...
    if (PyModule_AddIntMacro(m, PyCF_ALLOW_TOP_LEVEL_AWAIT) < 0)
        return NULL;
    if (PyDict_SetItemString(d, "NodeVisitor", (PyObject*)&NodeVisitor_type) <
        0) return NULL;
    if (initialize_nodevisitor_table(&NodeVisitor_type, NULL) < 0) return NULL;
