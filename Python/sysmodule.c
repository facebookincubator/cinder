...
static PyObject *
sys_get_method_cache_stats(PyObject *self)
{
    return _PyType_GetMethodCacheStats();
}

PyDoc_STRVAR(sys_get_method_cache_stats__doc__,
             "_get_method_cache_stats() -> Dict[str, int]\n\
Return a mapping of the following method cache statistics to their values: \n\
num_hits\n\
num_misses\n\
num_collisions.");

static PyObject *
sys_reset_method_cache_stats(PyObject *self)
{
    _PyType_ResetMethodCacheStats();
    Py_RETURN_NONE;
}

PyDoc_STRVAR(sys_reset_method_cache_stats__doc__,
             "_reset_method_cache_stats() -> None\n\
Reset the number of hits, misses, and collisions encountered in the method\n\
cache to zero.");

static PyObject *
set_method_free_list_size(PyObject *self, PyObject *size_obj)
{
    size_t size = PyLong_AsSize_t(size_obj);
    if (PyErr_Occurred() != NULL) {
        return NULL;
    }
    _PyMethod_SetFreeListSize(size);
    Py_RETURN_NONE;
}

PyDoc_STRVAR(set_method_free_list_size__doc__,
             "_set_method_free_list_size(size: int) --> None\n\
Sets the maximum number of method objects to be cached and re-used.");

static PyObject *
sys_get_method_free_list_size(PyObject *self, PyObject *noargs)
{
    return PyLong_FromSize_t(_PyMethod_GetFreeListSize());
}

PyDoc_STRVAR(sys_get_method_free_list_size__doc__,
             "_get_method_free_list_size() -> int\n\
Return the maximum number of method objects that will be cached and re-used.");

static PyObject *
sys_get_method_free_list_stats(PyObject *self, PyObject *noargs)
{
    return _PyMethod_GetFreeListStats();
}

PyDoc_STRVAR(sys_get_method_free_list_stats__doc__,
             "_get_method_free_list_size() -> tuple\n\
Gets information about the method free list cache.  Returns a tuple where the\n\
first element is the current number of entries in the cache, the second\n\
element is the number of cache hits, and the third is the number of cache\n\
misses.\n\
\n\
If free list stats are not enabled the 2nd and 3rd values will be -1.");
...
static PyObject *
sys__get_method_cache_stats_impl(PyObject *module)
/*[clinic end generated code: output=61617c5bfab3d338 input=e1d50927190317a1]*/
{
    return _PyType_GetMethodCacheStats();
}
...
static PyObject *
sys__reset_method_cache_stats_impl(PyObject *module)
/*[clinic end generated code: output=f2874d74668f3a91 input=5a01805437997905]*/
{
    _PyType_ResetMethodCacheStats();
    Py_RETURN_NONE;
}
...
/*[clinic input]
sys._get_method_cache_occupancy

_get_method_cache_occupancy() -> Tuple[int, int]

Returns the number of total method cache slots and the number of filled
slots as a tuple.
[clinic start generated code]*/

static PyObject *
sys__get_method_cache_occupancy_impl(PyObject *module)
/*[clinic end generated code: output=bca6f9438ef51d30 input=9709e99290b8dcbb]*/
{
    return _PyType_GetMethodCacheOccupancy();
}
...
static PyMethodDef sys_methods[] = {
    ...
    SYS_GETTOTALREFCOUNT_METHODDEF SYS_GETREFCOUNT_METHODDEF
        SYS_GETRECURSIONLIMIT_METHODDEF{
            "getsizeof",
            (PyCFunction)(void (*)(void))sys_getsizeof,
    ...
    {"_get_method_cache_stats",
     (PyCFunction)sys_get_method_cache_stats,
     METH_NOARGS,
     sys_get_method_cache_stats__doc__},
    {"_reset_method_cache_stats",
     (PyCFunction)sys_reset_method_cache_stats,
     METH_NOARGS,
     sys_reset_method_cache_stats__doc__},
    {"_set_method_free_list_size",
     set_method_free_list_size,
     METH_O,
     set_method_free_list_size__doc__},
    {"_get_method_free_list_size",
     sys_get_method_free_list_size,
     METH_NOARGS,
     sys_get_method_free_list_size__doc__},
    {"_get_method_free_list_stats",
     sys_get_method_free_list_stats,
     METH_NOARGS,
     sys_get_method_free_list_stats__doc__},
    /* facebook begin t20378525 */
    {"inline_cache_stats",
    ...
    SYS__GET_METHOD_CACHE_STATS_METHODDEF
    SYS__RESET_METHOD_CACHE_STATS_METHODDEF
    SYS__GET_METHOD_CACHE_OCCUPANCY_METHODDEF
                ...
                PyObject *sysdict)
{
    ...
    SET_SYS_FROM_STRING("_built_with_asan", Py_True);
#elif defined(__has_feature)
#  if __has_feature(address_sanitizer)
      SET_SYS_FROM_STRING("_built_with_asan", Py_True);
#  else
      SET_SYS_FROM_STRING("_built_with_asan", Py_False);
#  endif
#else
    SET_SYS_FROM_STRING("_built_with_asan", Py_False);
#endif
