...
#define PY_OPCODES(X) \
  ...
  X(PRIMITIVE_UNBOX_ENUM,            205) \
  X(PRIMITIVE_UNBOX_NUMERIC,         206) \
...
#define READONLY_OPERATIONS(X) \
  ...
  X(READONLY_BINARY_ADD, 2) \
  X(READONLY_BINARY_SUBTRACT, 3) \
  X(READONLY_BINARY_MULTIPLY, 4) \
  X(READONLY_BINARY_MATRIX_MULTIPLY, 5) \
  X(READONLY_BINARY_TRUE_DIVIDE, 6) \
  X(READONLY_BINARY_FLOOR_DIVIDE, 7) \
  X(READONLY_BINARY_MODULO, 8) \
  X(READONLY_BINARY_POWER, 9) \
  X(READONLY_BINARY_LSHIFT, 10) \
  X(READONLY_BINARY_RSHIFT, 11) \
  X(READONLY_BINARY_OR, 12) \
  X(READONLY_BINARY_XOR, 13) \
  X(READONLY_BINARY_AND, 14) \
  X(READONLY_UNARY_INVERT, 15) \
  X(READONLY_UNARY_NEGATIVE, 16) \
  X(READONLY_UNARY_POSITIVE, 17) \
  X(READONLY_UNARY_NOT, 18) \
  X(READONLY_COMPARE_OP, 19) \
  X(READONLY_CHECK_LOAD_ATTR, 20) \
  X(READONLY_CHECK_STORE_ATTR, 21) \
  X(READONLY_GET_ITER, 22) \
  X(READONLY_FOR_ITER, 23) \
  X(READONLY_POP_JUMP_IF_TRUE, 24) \
  X(READONLY_POP_JUMP_IF_FALSE, 25)
