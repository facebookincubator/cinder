...
/* Clear the no shadowing instances flag on type.
 *
 * If obj is NULL, the flag is cleared unconditionally.
 * If obj is non-NULL, the flag is cleared if obj is a function or method.
 */
...
/* Function to get stats of method cache */
...
#define Py_TPFLAGS_WARN_ON_SETATTR (1UL << 8)
...
static inline int _Py_IsImmortal(PyObject* ob) {
#if SIZEOF_VOID_P > 4
...
#ifndef Py_LIMITED_API
PyAPI_FUNC(int) _PyType_InitSwitchboard(void);
/* Returns a borrowed reference */
PyAPI_FUNC(PyObject *) _PyType_GetSwitchboard(void);
PyAPI_FUNC(void) _PyType_ClearSwitchboard(void);
#endif
