...
PyDoc_STRVAR(gc_enable_parallel_collection__doc__,
"enable_parallel_collection($module, /, min_generation=2, num_threads=0)\n"
"--\n"
"\n"
"Enable parallel garabage for generations >= `min_generation`.\n"
"\n"
"Use `num_threads` threads to perform collection in parallel. When this value\n"
"is <= 0 the number of threads is half the number of processors.\n"
"\n"
...
#define GC_ENABLE_PARALLEL_COLLECTION_METHODDEF    \
    {"enable_parallel_collection", (PyCFunction)(void(*)(void))gc_enable_parallel_collection, METH_FASTCALL|METH_KEYWORDS, gc_enable_parallel_collection__doc__},
...
static PyObject *
gc_enable_parallel_collection(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"min_generation", "num_threads", NULL};
    static _PyArg_Parser _parser = {NULL, _keywords, "enable_parallel_collection", 0};
    PyObject *argsbuf[2];
    Py_ssize_t noptargs = nargs + (kwnames ? PyTuple_GET_SIZE(kwnames) : 0) - 0;
    int min_generation = NUM_GENERATIONS - 1;
    int num_threads = 0;
    ...
    if (args[0]) {
        min_generation = _PyLong_AsInt(args[0]);
        if (min_generation == -1 && PyErr_Occurred()) {
            goto exit;
        }
        if (!--noptargs) {
            goto skip_optional_pos;
    ...
    num_threads = _PyLong_AsInt(args[1]);
    if (num_threads == -1 && PyErr_Occurred()) {
        goto exit;
    }
skip_optional_pos:
    return_value = gc_enable_parallel_collection_impl(module, min_generation, num_threads);

exit:
    return return_value;
}

PyDoc_STRVAR(gc_disable_parallel_collection__doc__,
"disable_parallel_collection($module, /)\n"
"--\n"
"\n"
...
#define GC_DISABLE_PARALLEL_COLLECTION_METHODDEF    \
    {"disable_parallel_collection", (PyCFunction)gc_disable_parallel_collection, METH_NOARGS, gc_disable_parallel_collection__doc__},

static PyObject *
gc_disable_parallel_collection_impl(PyObject *module);

static PyObject *
gc_disable_parallel_collection(PyObject *module, PyObject *Py_UNUSED(ignored))
{
    return gc_disable_parallel_collection_impl(module);
}

PyDoc_STRVAR(gc_get_parallel_collection_settings__doc__,
"get_parallel_collection_settings($module, /)\n"
"--\n"
"\n"
...
"enabled:\n"
"\n"
"    num_threads: Number of thread used.\n"
"    min_generation: The minimum generation for which parallel collection is enabled.");

#define GC_GET_PARALLEL_COLLECTION_SETTINGS_METHODDEF    \
    {"get_parallel_collection_settings", (PyCFunction)gc_get_parallel_collection_settings, METH_NOARGS, gc_get_parallel_collection_settings__doc__},

static PyObject *
gc_get_parallel_collection_settings_impl(PyObject *module);

static PyObject *
gc_get_parallel_collection_settings(PyObject *module, PyObject *Py_UNUSED(ignored))
{
    return gc_get_parallel_collection_settings_impl(module);
}
/*[clinic end generated code: output=f0ec9e77557463e7 input=a9049054013a1b77]*/
