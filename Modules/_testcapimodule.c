...
static PyObject *
set_func_defaults_via_capi(PyObject *module, PyObject *args)
{
    PyObject *func, *defaults;
...
static PyObject *
set_func_kwdefaults_via_capi(PyObject *module, PyObject *args)
{
    PyObject *func, *defaults;
    if (!PyArg_ParseTuple(args, "OO", &func, &defaults)) {
        return NULL;
...
static PyMethodDef TestMethods[] = {
    ...
    {"set_func_kwdefaults_via_capi", set_func_kwdefaults_via_capi, METH_VARARGS},
    {"allocate_too_many_func_watchers", allocate_too_many_func_watchers, METH_NOARGS},
    {NULL, NULL} /* sentinel */
};
...
PyInit__testcapi(void)
{
    ...
    /* Expose each func watcher event as an attribute on the module */
#define ADD_EVENT(event)  \
    if (add_func_event(m, "PYFUNC_EVENT_" #event,   \
