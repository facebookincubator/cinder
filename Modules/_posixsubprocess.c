...
static pid_t _fork_without_atfork_handlers(void)
{
  /* syscall() takes care of setting errno */
  return syscall(SYS_clone, SIGCHLD, NULL, NULL, NULL, NULL);
}
...
#define _fork_without_atfork_handlers fork
...
subprocess_fork_exec(PyObject* self, PyObject *args)
{
    ...
    if (preexec_fn != Py_None) {
        ...
        pid = _fork_without_atfork_handlers();
    }
