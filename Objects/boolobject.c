...
static PyObject*
bool_vectorcall(PyTypeObject *type, PyObject **args, size_t nargsf, PyObject *kwnames)
{
    if (!_PyArg_NoKwnames("bool", kwnames)) {
        return NULL;
    }
    PyObject *x = Py_False;
    if (!_PyArg_UnpackStack(args, PyVectorcall_NARGS(nargsf), "bool", 0, 1, &x)) {
        return NULL;
    }
...
PyTypeObject PyBool_Type = {
    ...
    0,                                          /* tp_alloc */
    bool_new,                                   /* tp_new */
    .tp_vectorcall = (vectorcallfunc)bool_vectorcall,
};
