...
static PyGetSetDef frame_getsetlist[] = {
    ...
    {"f_back",         (getter)frame_getf_back, NULL, NULL, NULL},
    {0}
};
...
/* Steals a reference to builtins */
PyFrameObject * _Py_HOT_FUNCTION
_PyFrame_NewWithBuiltins_NoTrack(PyThreadState *tstate, PyCodeObject *code,
                     ...
                     PyObject *globals, PyObject *locals)
{
    ...
    return _PyFrame_NewWithBuiltins_NoTrack(
        tstate, code, globals, builtins, locals);
}
