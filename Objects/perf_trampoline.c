 ...
 */
typedef PyObject *(*py_evaluator)(PyThreadState *, PyFrameObject *,
                                  int throwflag);
typedef PyObject *(*py_trampoline)(PyThreadState *, PyFrameObject *, int,
                                   py_evaluator);
...
static PyObject *
py_trampoline_evaluator(PyThreadState *ts, PyFrameObject *frame,
                        int throw)
{
