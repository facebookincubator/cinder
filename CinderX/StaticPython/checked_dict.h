...
CiAPI_FUNC(int) Ci_CheckedDict_SetItemInternal(PyObject *op, PyObject *key, PyObject *value);

CiAPI_FUNC(int) Ci_DictOrChecked_SetItemInternal(PyObject *op, PyObject *key, PyObject *value);
