...
importlib.set_lazy_imports(False)                                                               # disable lazy imports
from test.lazyimports.importlib_apis.customized_modules import module_is_lazy_import_also_eager
assert not importlib.is_lazy_import(globals(), "module_is_lazy_import_also_eager")              # should be eager
