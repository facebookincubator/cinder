...
class TypesTests(unittest.TestCase):
    ...
    def test_or_types_operator(self):
        ...
        self.assertEqual(str | None, typing.Union[str, None])
    ...
    def test_or_type_operator_with_SpecialForm(self):
        ...
        assert str | int != typing.Tuple[str, int]

    def test_or_type_repr(self):
        assert repr(int | None) == "int | None"

    def test_or_type_hash_consistency(self):
        self.assertEqual(hash(int | str), hash(str | int))
        self.assertEqual(hash(typing.Union[str, int]), hash(str | int))
        self.assertEqual(hash(typing.Union[str, None]), hash(str | None))
