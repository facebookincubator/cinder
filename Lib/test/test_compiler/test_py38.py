...
class Python38Tests(CompilerTest):
    ...
    def _check(self, src, optimize=-1):
        ...
        actual = dump_code(self.compile(src, CodeGenerator, optimize=optimize))
...
def f():
    ...
    def test_posonly_args(self):
        code = self.compile("def f(a, /, b): pass", CodeGenerator)
