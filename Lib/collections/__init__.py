...
try:
    from cinderjit import jit_force_normal_frame
except ImportError:
    jit_force_normal_frame = lambda x: x
...
try:
    from _collections import _new_tuple
...
def namedtuple(typename, field_names, *, rename=False, defaults=None, module=None):
    ...
    if _new_tuple:
        ...
        namespace = {'_tuple_new': _new_tuple, '__name__': f'namedtuple_{typename}'}
    else:
        s = f'def __new__(_cls, {arg_list}): return _tuple_new(_cls, ({arg_list}))'
