...
def_op("INVOKE_METHOD", 164)
hasconst.append(164)

def_op("LOAD_FIELD", 165)
hasconst.append(165)
...
shadow_op("INVOKE_FUNCTION_CACHED", 213)
shadow_op("INVOKE_FUNCTION_INDIRECT_CACHED", 214)
shadow_op("BUILD_CHECKED_MAP_CACHED", 215)
shadow_op("CHECK_ARGS_CACHED", 216)
shadow_op("PRIMITIVE_STORE_FAST", 217)
shadow_op("CAST_CACHED_OPTIONAL", 218)
shadow_op("CAST_CACHED", 219)
shadow_op("CAST_CACHED_EXACT", 117)
shadow_op("CAST_CACHED_OPTIONAL_EXACT", 118)
