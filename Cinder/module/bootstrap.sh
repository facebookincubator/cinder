...
# In ordrer to build the cindervm .so we need a working version of Python to run
...
rm -rf "$PYTHON_FOR_CINDERVM_BUILD_DIR"
mkdir -p "$PYTHON_FOR_CINDERVM_BUILD_DIR"
cd "$PYTHON_FOR_CINDERVM_BUILD_DIR"
